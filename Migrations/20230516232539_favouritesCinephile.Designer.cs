...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Proyect_Rotten_Tomatoes.Models.FavouriteMovies", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Proyect_Rotten_Tomatoes.Models.FavouriteSeries", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Proyect_Rotten_Tomatoes.Models.FavouriteMovies", b =>
                {
                    b.HasOne("Proyect_Rotten_Tomatoes.Models.Cinephile", "Cinephile")
                        .WithMany("FavouriteMovies")
                        .HasForeignKey("CinephileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Proyect_Rotten_Tomatoes.Models.Movie", "Movie")
                        .WithMany()
                        .HasForeignKey("MovieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Cinephile");
            ...
            modelBuilder.Entity("Proyect_Rotten_Tomatoes.Models.FavouriteSeries", b =>
                {
                    ...
                    b.HasOne("Proyect_Rotten_Tomatoes.Models.Serie", "Serie")
                        .WithMany()
